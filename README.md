...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="/w3images/jane.jpg" alt="CLASS DESCRIPTIONS" width="1600" height="1060">
    <div class="w3-display-left w3-padding-large">
      <h1 class="w3-text-white">2024 IB</h1>
      <h1 class="w3-jumbo w3-text-white w3-hide-small"><b>CLASS DESCRIPTIONS</b></h1>
